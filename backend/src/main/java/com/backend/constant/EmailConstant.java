...
public class EmailConstant {
    ...
    public static final String USERNAME = "netsdevs@gmail.com";
    public static final String PASSWORD = "maxim";
    public static final String FROM_EMAIL = "netsdevs@gmail.com";
